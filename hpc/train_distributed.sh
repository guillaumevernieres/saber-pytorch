...
# Usage:
#   sbatch hpc/train_distributed.sh [--config emulators/aice/config.yaml]
#
# The config can be overridden by setting SABER_CONFIG before submitting:
#   SABER_CONFIG=emulators/aice/both_domain.yaml sbatch hpc/train_distributed.sh
...
CONFIG=${SABER_CONFIG:-emulators/aice/config.yaml}
